...
//	public static <K, V> K getMaxMap(Map<K, V> map) {
//		Iterator<Entry<K, V>> mapIterator = map.entrySet().iterator();
//		
//		K returnKey = null;
//		int maxValue = 0;
//		
//		while(mapIterator.hasNext()) {
//			Entry<K, V> tempEntry = mapIterator.next();
//			
//			if((int)tempEntry.getValue() > maxValue) {
//				maxValue = (int) tempEntry.getValue();
//				returnKey = tempEntry.getKey();
//			}
//		}
//		
//		return returnKey;
