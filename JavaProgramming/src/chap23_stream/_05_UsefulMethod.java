...
public class _05_UsefulMethod {
	...
	public static void main(String... args) {
		...
		// 새로운 Stream에 담길 요소들을 리턴해줘야 되기 때문에 리턴구문이 필수적이다.
		intList.stream()
		...
		// 최종단계 메소드
		// reduce(누적값의 초기값, (누적값이 될 변수, 요소에 하나씩 접근할 변수, 요소의 인덱스(선택) -> 누적값에 누적할 실행코드);
