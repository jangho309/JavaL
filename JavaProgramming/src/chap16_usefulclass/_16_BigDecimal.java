...
public class _16_BigDecimal {
	...
	public static void main(String[] args) {
		...
		// 1. BigDecimal 객체 생성
		// 1-1 생성자를 통한 객체 생성
		BigDecimal bigDecimal1 = new BigDecimal(1.99999999999999999999999999999999999999999999);
		// 1-2. valueOf 메소드를 통한 객체 생성
		BigDecimal bigDecimal2 = BigDecimal.valueOf(3.14159265358979323846264338327950288419716939937510582097494459230781640628620899);
		...
		// 현재 소수점 자리수보다 큰 소수점 자리수를 지정하면 뒤에 0이 자동으로 붙는다.(반올림모드 지정하지 않음)
