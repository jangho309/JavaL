...
public class _10_ReferenceConstructor {
	...
	public static void main(String[] args) {
		...
		Academy computeAcademy = createComputerAcademy(Academy::new);
		Academy englishAcademy = createEngilshAcademy(Academy::new);
...
//		Academy mathAcademy = createMathAcademy(Academy::new);
	...
	public static Academy createEngilshAcademy(EnglishAcademy englishAcademy) {
